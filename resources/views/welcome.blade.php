...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <header class="flex flex-col items-center justify-center w-full h-screen py-24">
            <nav class="fixed top-0 right-0 z-10 w-full">
                <div class="flex items-center justify-between flex-shrink-0 py-2 mx-auto bg-white bg-opacity-75 max-w-7xl">
                    <div class="grid grid-cols-3 text-center">
                        <a href="#" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">Services</a>
                        <a href="#" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">Examples</a>
                        <a href="#" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">Pricing</a>
                    </div>
                    ...
                    <div class="hidden py-4 mx-6 sm:block">
                        <a href="#" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">Guides</a>
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" class="px-0 py-3 mx-6 text-sm font-semibold text-yellow-700 border-b-2 border-yellow-700 border-opacity-0 hover:border-opacity-75">My Account</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="px-6 py-2 ml-6 text-sm font-bold text-white bg-yellow-900 rounded-lg">Sign Up</a>
                                @endif
                            @endif
                        @endif
                    </div>
